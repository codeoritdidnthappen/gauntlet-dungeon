...
**New Game destroys the save outright.** Only one game is stored at a time, so
starting one is a destructive act, and the click does the deleting rather than
leaving it to the next autosave.
